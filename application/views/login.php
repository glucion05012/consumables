...
<head>
  <meta charset="UTF-8">
  <title>DENR-NCR Consumable Information System</title>
...
<h1 style="text-align: center; color:white"><img src="<?php echo base_url()."assets/"; ?>denr-emb-logo.gif" alt="Logo" class="brand-image "
           style="opacity: .8; height:50px; width: 50px;"><br>DENR NCR Inventory System</h1>
    <div style='color:red'>
